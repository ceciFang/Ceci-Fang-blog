...
语法：
[![github](https://img.shields.io/badge/github-xugaoyi-brightgreen.svg)](https://github.com/ceciFang)
```
...
```markdown
![其他仓库的图片1](https://github.com/ceciFang/vue-music/raw/master/src/common/image/default.png)
或
![其他仓库的图片2](https://raw.githubusercontent.com/xugaoyi/image_store/master/blog/md_logo.png)
```

![其他仓库的图片](https://github.com/ceciFang/vue-music/raw/master/src/common/image/default.png)
